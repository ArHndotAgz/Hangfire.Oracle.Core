...
namespace Hangfire.Oracle.Core
{
    internal class OracleWriteOnlyTransaction : JobStorageTransaction
    {
        ...
        public override void SetJobState(string jobId, IState state)
        {
            ...
            oracleDynamicParameters.Add("DATA", SerializationHelper.Serialize(state.SerializeData(), SerializationOption.User), GetClobMappingType(), ParameterDirection.Input);
