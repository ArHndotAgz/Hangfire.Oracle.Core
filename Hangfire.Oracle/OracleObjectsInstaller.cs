...
WHERE TABLE_NAME = '{jobTableName}'";
        ...
        private static string GenerateInstallScript(HangfireTableNameProvider tableNameProvider)
        {
            ...
            // Create sequences
            sb.AppendLine("CREATE SEQUENCE HF_SEQUENCE START WITH 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER;");
            sb.AppendLine();
            sb.AppendLine("CREATE SEQUENCE HF_JOB_ID_SEQ START WITH 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER;");
            sb.AppendLine();
